    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Subscription scanSubscription = rxBleClient.scanBleDevices()
                .subscribe(rxBleScanResult -> {
                    Log.d("res",rxBleScanResult.toString());
                });

        String macAddress = "90:70:65:2C:DD:B5";
        ...
        /*Subscription subscription = rxBleDevice.establishConnection(this, false) // <-- autoConnect flag
                .flatMap(rxBleConnection -> rxBleConnection.setupNotification(characteristicUUID))
                .doOnNext(notificationObservable -> {
                    Toast.makeText(this,"Notifications ready", Toast.LENGTH_LONG).show();
                })
                .flatMap(notificationObservable -> notificationObservable) // <-- Notification has been set up, now observe value changes.
                .subscribe(bytes -> {
                    Toast.makeText(this, "New bytes : " + bytes.toString(), Toast.LENGTH_LONG).show();
                });
